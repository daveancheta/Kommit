...
export function LoginForm({
  ...
  const { isSubmitting, handleSignInValidation, handleGithubSign } = UseAuthStore()
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <form onSubmit={handleSignin}>
        <FieldGroup>
          ...
          <Field>
            <Button type="submit" disabled={isSubmitting}>{isSubmitting && <Loader2 className="animate-spin w-4 h-4" />} Login</Button>
          </Field>
