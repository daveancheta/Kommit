...
import { GalleryVerticalEndIcon, GitGraph, Loader2 } from "lucide-react"
...
export function RegisterForm({
  ...
  const { isSubmitting, handleSignUpValidation, handleGithubSign } = UseAuthStore()
        ...
        <FieldGroup>
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            >
              ...
              <span className="sr-only">Kommit.</span>
            </a>
          ...
          <Field>
            <Button type="submit" disabled={isSubmitting}>{isSubmitting && <Loader2 className="animate-spin w-4 h-4"/>} Sign up</Button>
          </Field>
          <FieldSeparator>Or</FieldSeparator>
          <Field>
            <Button variant="outline" type="button" disabled={isSubmitting} onClick={handleGithubSign}>
